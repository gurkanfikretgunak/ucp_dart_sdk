...
mixin _$PaymentInstrument {
  @JsonKey(
    fromJson: _cardPaymentInstrumentFromJson,
    toJson: _cardPaymentInstrumentToJson,
  )
  CardPaymentInstrument get root => throw _privateConstructorUsedError;

  /// Serializes this PaymentInstrument to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of PaymentInstrument
...
abstract class $PaymentInstrumentCopyWith<$Res> {
  factory $PaymentInstrumentCopyWith(
    ...
    $Res Function(PaymentInstrument) then,
  ...
  $CardPaymentInstrumentCopyWith<$Res> get root;
}
...
class _$PaymentInstrumentCopyWithImpl<$Res, $Val extends PaymentInstrument>
  ...
  @pragma('vm:prefer-inline')
  $CardPaymentInstrumentCopyWith<$Res> get root {
    return $CardPaymentInstrumentCopyWith<$Res>(_value.root, (value) {
...
abstract class _$$PaymentInstrumentImplCopyWith<$Res>
    implements $PaymentInstrumentCopyWith<$Res> {
  factory _$$PaymentInstrumentImplCopyWith(
    _$PaymentInstrumentImpl value,
...
class __$$PaymentInstrumentImplCopyWithImpl<$Res>
  ...
  __$$PaymentInstrumentImplCopyWithImpl(
    _$PaymentInstrumentImpl _value,
...
class _$PaymentInstrumentImpl implements _PaymentInstrument {
  ...
  final CardPaymentInstrument root;

  @override
  String toString() {
    return 'PaymentInstrument(root: $root)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$PaymentInstrumentImplToJson(this);
  }
}

abstract class _PaymentInstrument implements PaymentInstrument {
  const factory _PaymentInstrument(
    @JsonKey(
      fromJson: _cardPaymentInstrumentFromJson,
      toJson: _cardPaymentInstrumentToJson,
    )
  ...
  CardPaymentInstrument get root;
