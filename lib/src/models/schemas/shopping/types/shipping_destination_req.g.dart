...
ShippingDestinationRequest _$ShippingDestinationRequestFromJson(
...
Map<String, dynamic> _$ShippingDestinationRequestToJson(
  ShippingDestinationRequest instance,
) => <String, dynamic>{
  'id': instance.id,
