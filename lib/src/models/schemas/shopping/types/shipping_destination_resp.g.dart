...
ShippingDestinationResponse _$ShippingDestinationResponseFromJson(
...
Map<String, dynamic> _$ShippingDestinationResponseToJson(
  ShippingDestinationResponse instance,
) => <String, dynamic>{
  'id': instance.id,
