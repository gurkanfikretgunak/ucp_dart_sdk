...
mixin _$PaymentCreateRequest {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PaymentCreateRequestCopyWith<PaymentCreateRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PaymentCreateRequestCopyWith<$Res> {
  factory $PaymentCreateRequestCopyWith(
    PaymentCreateRequest value,
    $Res Function(PaymentCreateRequest) then,
  ) = _$PaymentCreateRequestCopyWithImpl<$Res, PaymentCreateRequest>;
  @useResult
  $Res call({
...
/// @nodoc
class _$PaymentCreateRequestCopyWithImpl<
  $Res,
  $Val extends PaymentCreateRequest
>
    implements $PaymentCreateRequestCopyWith<$Res> {
  _$PaymentCreateRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PaymentCreateRequestImplCopyWith<$Res>
    implements $PaymentCreateRequestCopyWith<$Res> {
  factory _$$PaymentCreateRequestImplCopyWith(
    _$PaymentCreateRequestImpl value,
    $Res Function(_$PaymentCreateRequestImpl) then,
  ) = __$$PaymentCreateRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    @JsonKey(name: 'selected_instrument_id') String? selectedInstrumentId,
...
/// @nodoc
class __$$PaymentCreateRequestImplCopyWithImpl<$Res>
    extends _$PaymentCreateRequestCopyWithImpl<$Res, _$PaymentCreateRequestImpl>
    implements _$$PaymentCreateRequestImplCopyWith<$Res> {
  __$$PaymentCreateRequestImplCopyWithImpl(
    _$PaymentCreateRequestImpl _value,
    $Res Function(_$PaymentCreateRequestImpl) _then,
  ) : super(_value, _then);
...
class _$PaymentCreateRequestImpl extends _PaymentCreateRequest {
  const _$PaymentCreateRequestImpl({
  ...
  @override
  String toString() {
    return 'PaymentCreateRequest(selectedInstrumentId: $selectedInstrumentId, instruments: $instruments, extra: $extra)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PaymentCreateRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PaymentCreateRequestImplCopyWith<_$PaymentCreateRequestImpl>
  get copyWith =>
      __$$PaymentCreateRequestImplCopyWithImpl<_$PaymentCreateRequestImpl>(
        this,
        _$identity,
      );
}

abstract class _PaymentCreateRequest extends PaymentCreateRequest {
  const factory _PaymentCreateRequest({
    @JsonKey(name: 'selected_instrument_id') final String? selectedInstrumentId,
    final List<PaymentInstrument>? instruments,
    @JsonKey(includeFromJson: false, includeToJson: false)
    final Map<String, dynamic>? extra,
  }) = _$PaymentCreateRequestImpl;
  const _PaymentCreateRequest._() : super._();
