...
DiscountCheckoutUpdateRequest _$DiscountCheckoutUpdateRequestFromJson(
...
Map<String, dynamic> _$DiscountCheckoutUpdateRequestToJson(
  DiscountCheckoutUpdateRequest instance,
) => <String, dynamic>{
  'id': instance.id,
...
_$$DiscountExtensionUpdateRequestImplFromJson(Map<String, dynamic> json) =>
    _$DiscountExtensionUpdateRequestImpl(json['root'] as Map<String, dynamic>);

Map<String, dynamic> _$$DiscountExtensionUpdateRequestImplToJson(
  _$DiscountExtensionUpdateRequestImpl instance,
